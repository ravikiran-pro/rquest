...
async function authMiddleware(req, res, next){
    try{
        ...
        res.status(500).json({ error: 'Authentication Failed', message: 'Authentication Failed' });
    }
}

module.exports = {generateHash, validateUser, generateJwt, verifyJwt, authMiddleware}